...
The Engine is entirely unconcerned with _how_ or _where_ it is executed. It has absolutely no knowledge of DOM elements, browser APIs, or network requests.
